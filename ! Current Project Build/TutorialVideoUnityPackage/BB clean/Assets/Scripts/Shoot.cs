...
private GameObject bulletSpawn;
	...
	public void charge()
	{
			...
			if (Input.GetMouseButtonUp(0) && chargeTime >= 1.0f && chargeTime <= 2.0f)
				{
					...
					_movementAnimator.SetTrigger("TrShoot");
					_movementAnimator.SetTrigger("TrIdle");   
				}
				else

				if (Input.GetMouseButtonUp(0) && chargeTime >= 2.0f && chargeTime <= 3.0f)
				{
				...
				if (Input.GetMouseButtonUp(0) && chargeTime >= 3.0f)
				{
